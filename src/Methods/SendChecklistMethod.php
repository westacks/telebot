 ...
 * @property-read ?string $message_effect_id Unique identifier of the message effect to be added to the message
 * @property-read ?ReplyParameters $reply_parameters A JSON-serialized object for description of the message to reply to
 * @property-read ?InlineKeyboardMarkup $reply_markup A JSON-serialized object for an inline keyboard
 *
 * @see https://core.telegram.org/bots/api#sendchecklist
 */
class SendChecklistMethod extends TelegramMethod
{
    protected string $method = 'sendChecklist';
