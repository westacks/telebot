 ...
 * @property-read int|string $chat_id Unique identifier for the target chat or username of the target bot, supergroup or channel in the format @username. Polls can't be sent to channel direct messages chats.
 ...
 * @property-read ?InputPollMedia $explanation_media Media added to the quiz explanation
 ...
 * @property-read ?InputPollMedia $media Media added to the poll description
...
class SendPollMethod extends TelegramMethod
{
    ...
    public function __construct(
        ...
        public readonly ?InputPollMedia $explanation_media,
        ...
        public readonly ?InputPollMedia $media,
