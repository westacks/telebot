 ...
 * @property-read InputFile|string $video Video to send. Pass a file_id as String to send a video that exists on the Telegram servers (recommended), pass an HTTP URL as a String for Telegram to get a video from the Internet, or upload a new video using multipart/form-data. More information on Sending Files »
 ...
 * @property-read null|InputFile|string $cover Cover for the video in the message. Pass a file_id to send a file that exists on the Telegram servers (recommended), pass an HTTP URL for Telegram to get a file from the Internet, or pass “attach://<file_attach_name>” to upload a new one using multipart/form-data under <file_attach_name> name. More information on Sending Files »
 * @property-read ?int $start_timestamp Start timestamp for the video in the message
 ...
 * @property-read ?bool $supports_streaming Pass True if the uploaded video is suitable for streaming
...
class SendVideoMethod extends TelegramMethod
{
    ...
    public function __construct(
        ...
        public readonly null|InputFile|string $cover,
