 ...
 * @property string          $has_private_forwards      _Optional_. True, if privacy settings of the other party in the private chat allows to use tg://user?id=<user_id> links only in chats with the user. Returned only in getChat.
 ...
 * @property int             $message_auto_delete_time  _Optional_. The time after which all messages sent to the chat will be automatically deleted; in seconds. Returned only in getChat.
 * @property bool            $has_protected_content     _Optional_. True, if messages from the chat can't be forwarded to other chats. Returned only in getChat.
