 ...
 * @property-read string $type Type of the result, must be live_photo
 ...
 * @property-read ?bool $has_spoiler Optional. Pass True if the live photo needs to be covered with a spoiler animation
 *
