 ...
 * @property KeyboardButtonRequestUsers $request_users    Optional. If specified, pressing the button will open a list of suitable users. Tapping on any user will send their identifier to the bot in a “users_shared” service message. Available in private chats only.
