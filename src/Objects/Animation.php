 ...
 * @property-read ?PhotoSize $thumbnail Optional. Animation thumbnail as defined by the sender
 * @property-read ?string $file_name Optional. Original animation filename as defined by the sender
