 ...
 * @property-read ?Message $guest_message Optional. New guest message. The bot can use the field Message.guest_query_id and the method answerGuestQuery to send a message in response.
 ...
 * @property-read ?MessageGenerationStopped $stopped_message_generation Optional. A user asked the bot to stop the generation of a message
 *
...
class Update extends TelegramObject
{
    public function __construct(
        ...
        public readonly ?Message $guest_message,
        ...
        public readonly ?MessageGenerationStopped $stopped_message_generation,
    ) {
    }
