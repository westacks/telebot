 ...
 * @method Array<GameHighScore>|PromiseInterface|False      getGameHighScores(array $parameters = [])                   Use this method to get data for high score tables. Will return the score of the specified user and several of their neighbors in a game. On success, returns an Array of GameHighScore objects.
 ...
 * @method Message|PromiseInterface|False                   sendGame(array $parameters = [])                            Use this method to send a game. On success, the sent Message is returned.
 * @method Message|PromiseInterface|False                   sendInvoice(array $parameters = [])                         Use this method to send invoices. On success, the sent Message is returned.
